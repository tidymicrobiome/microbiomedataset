...
filter.microbiome_dataset <-
  function(.data, ..., .preserve = FALSE) {
    ...
    if (.data@activated == "sample_info") {
      .data@expression_data <-
        .data@expression_data[, as.character(x$sample_id), drop = FALSE]
    }
    ...
    if (.data@activated == "variable_info") {
      ...
      # }
      .data@expression_data <-
        .data@expression_data[as.character(x$variable_id), , drop = FALSE]
    }
...
arrange.microbiome_dataset <-
  function(.data, ...) {
    ...
    if (.data@activated == "sample_info") {
      .data@expression_data = .data@expression_data[, as.character(x$sample_id), drop = FALSE]
    }
    
    if (.data@activated == "variable_info") {
      .data@expression_data = .data@expression_data[as.character(x$variable_id), ]
    }
