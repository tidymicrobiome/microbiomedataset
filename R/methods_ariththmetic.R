...
#' @method log microbiome_dataset
#' @param x x
#' @param base base
#' @export
#' @rdname arithmetic-microbiome_dataset
#' @return microbiome_dataset object

log.microbiome_dataset = function(x, base = exp(1)) {
...
#' @title abs
#' @method abs microbiome_dataset
#' @param x x
#' @export
#' @rdname arithmetic-microbiome_dataset
#' @return microbiome_dataset object

abs.microbiome_dataset = function(x) {
  expression_data = x@expression_data
...
#' @title sqrt
#' @method sqrt microbiome_dataset
#' @param x x
#' @export
#' @rdname arithmetic-microbiome_dataset
#' @return microbiome_dataset object

sqrt.microbiome_dataset = function(x) {
  expression_data = x@expression_data
...
#' @title scale
#' @method scale microbiome_dataset
#' @param x x
#' @param center center
#' @param scale scale
#' @export
...
#' @title +
#' @method + microbiome_dataset
#' @param e1 a microbiome_dataset class object
#' @param e2 numeric
#' @export
#' @rdname arithmetic-microbiome_dataset
#' @return microbiome_dataset object
...
setMethod(f = "+",
          signature(e1 = "microbiome_dataset", e2 = "numeric"),
          function (e1, e2) {
...
setMethod(f = "-",
          signature(e1 = "microbiome_dataset", e2 = "numeric"), function (e1, e2) {
            e1@expression_data = e1@expression_data - e2
...
#' #' @title colSums
#' #' @method colSums microbiome_dataset
#' #' @param x x
#' #' @param na.rm na.rm
#' #' @param dims dims
#' #' @export
...
#'
#' colSums.microbiome_dataset = function(x, na.rm = FALSE, dims = 1){
...
setMethod(f = "colSums",
          signature(x = "microbiome_dataset"),
          function (x, na.rm = FALSE, dims = 1) {
            colSums(x@expression_data, na.rm = na.rm, dims = dims)
          })

#' #' @title rowSums
#' #' @method rowSums microbiome_dataset
#' #' @param x x
#' #' @param na.rm na.rm
#' #' @param dims dims
#' #' @export
...
#' #' @return vector object
#'
#' rowSums.microbiome_dataset = function(x, na.rm = FALSE, dims = 1){
...
#' #' @title colMeans
#' #' @method colMeans microbiome_dataset
#' #' @param x x
#' #' @param na.rm na.rm
#' #' @param dims dims
#' #' @export
...
#' #' @return vector object
#'
#' colMeans.microbiome_dataset = function(x, na.rm = FALSE, dims = 1){
...
#' #' @title rowMeans
#' #' @method rowMeans microbiome_dataset
#' #' @param x x
#' #' @param na.rm na.rm
#' #' @param dims dims
#' #' @export
...
#' #' @return vector object
#'
#' rowMeans.microbiome_dataset = function(x, na.rm = FALSE, dims = 1){
